      ...
      <>
        ...
        <div className='pt-4'>
            <form onSubmit={onSubmit} autoComplete='off'>
                <label>Email</label>
                <input type='email' name='email' value={values?.email} onChange={handleOnChange} placeholder='Email address' className='h-[48px] w-full border p-2 mt-2 mb-4 border-gray-400' required/>
